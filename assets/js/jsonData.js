...
for(obj of Object.entries(tbodyChildren)){
    const recordChildren = obj[1];
    console.log(obj[0]);
    rtoData.push({
        id          : obj[0]+1,
        code        : recordChildren.children[0].innerText,
        location    : recordChildren.children[1].innerText,
        type        : recordChildren.children[2].innerText,
        district    : recordChildren.children[3].innerText,
    })
}
